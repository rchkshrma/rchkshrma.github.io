...
<head>
    ...
    <script src="AddComm.js" defer></script>
...
<body>
    <div class="body">
        ...
        <main class="main">
            ...
            <article>
                <h1 id="H1Title"><span>A</span>dd <span>C</span>omments</h1>
                <form id="Form" method="POST" action="AddComments.php">
                    <fieldset>
                        <div id="div1">
                            <textarea name="Comm" id="Comm" cols="30" rows="10" placeholder="Enter Text Here...." ></textarea>
                            <p class="Error" id="commError">Field is required!</p>
                        </div>
                        <div id="Button">
